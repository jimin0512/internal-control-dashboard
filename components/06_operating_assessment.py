...
result_counts = (
    operating_df.groupby("운영평가결과").size().sort_values(ascending=False)
)
...
ax.set_title("운영평가 결과 현황", fontsize=15, pad=15)
ax.set_xlabel("운영평가결과", fontsize=12)
...
output_path = os.path.join(OUTPUT_DIR, "06_operating_assessment.png")
